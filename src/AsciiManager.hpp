...
struct AsciiManager
{
    ...
    void FUN_00422bb0(i32 bossMarkerIdx, i16 interrupt);
    void SetBossMarkerPosition(i32 bossMarkerIdx, Float3 *position);
    void SetBossMarkerState(i32 bossMarkerIdx, i32 state);
