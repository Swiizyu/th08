...
#pragma var_order(i, bomb, entry, cnt, base)
void Player::FUN_00413990()
{
    ...
    {
        base = g_Rng.GetRandomF32SignedInRange(ZUN_PI);
        cnt = 0;
        ...
        g_SoundPlayer.PlaySoundPositionedByIdx((SoundIdx)0xf, *(f32 *)(entry + 0x14));
        ScreenEffect::RegisterChain((ScreenEffectType)1, 0x1e, 8, 0, 0, 21);
        ScreenEffect::RegisterChain((ScreenEffectType)3, 8, 1, 0xe0f0f0f0, 0, 21);
    }
